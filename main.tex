...
\subsection*{Functional variation (identification of resistance alleles)}
...
%% Paragraph 1 - Overview and recapitulation of haplotype clustering results from Ag1000G phase 1. Introduce F1-F5, S1-S5. Which clusters implied spread. Sentence about here we extend analyses blah blah.
%
...
%% Paragraph 2 - Introduce haplotype networks, confirm major haplotype clustering for 995 alleles.
%
...
%% Paragraph 3 - Interesting observations from networks. Including comparison between S and F networks for amount of other non-syn changes. Also inference of multiple introgression events between species within F1.
%
...
%% Figure 3 - Overall haplotype age distribution.
%
\begin{figure}[!b]
...
%% Paragraph 4 - Limitations of clustering and networks based on genetic distance. Introduce analyses of haplotype age, how they work, what we’ve done in overview.
%
...
%% Paragraph 5 - Describe overall age distribution, bimodality, justify age at which we cut (maximum age of a selective sweep). Then describe what that does to the clustering by age, compare with previous clustering by genetic distance.
%
...
%% Paragraph 6 - What can we infer about spread (within haplogroups)? What can we say? Generally, F older than S, although not clear cut. Talk about F1, clear result that flow into central africa. S3 hard to call, difficult to see direction. Alternative hypothesis is flow from an unsampled third population to both UG and KE, however also rule out because not separate sub-clades. Suggest complex multiple gene flow events. Talk about the CM/GA haplogroups, but caveat about sampling dates and ages are uncalibrated. Not the same pattern for all three haplogroups, suggesting multiple gene flow events, but cannot go further without more sampling.
%
