...
%% L995F, L995S
The two known resistance variants affecting codon 995 had the highest overall allele frequencies within the Ag1000G phase 1 cohort.
%
...
%
As expected, we found \texttt{N1570Y} in almost perfect LD with \texttt{L995F}, meaning that \texttt{N1570Y} was only ever found on haplotypes also carrying \texttt{L995F}.
%%
...
%
These included two variants in codon 1874 (\texttt{P1874S}, \texttt{P1874L}).
%
P1874S has previously been found in a colony of the crop pest \textit{Plutella xylostella} with a pyrethroid resistance phenotype, but has not been experimentally shown to confer resistance @@REF.
%
...
%
First, \textit{Vgsc} is a highly conserved gene, expected to be under strong functional constraint and therefore purifying selection @@REF.
%
...
%
This contrast was highly significant -- incorporating data for all variants found within the gene, the ratio of non-synonymous to synonymous nucleotide diversity (@@piN/piS) was @@N times higher among haplotypes carrying L995F relative to haplotypes carrying L995S (@@Test; P = @@).
%
...
%
Codon 402 also occurs within a trans-membrane segment (\texttt{I.S6}), and the \texttt{V402L} substitution has been independently associated with pyrethroid resistance in bedbugs \cite{Yoon2008}.
%
...
%
The remaining 4 novel alleles (two causing \texttt{M490I}; \texttt{A1125V}; \texttt{V1254I}) do not occur in combination with any known resistance allele.
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection*{Prediction of putative resistance phenotype}
