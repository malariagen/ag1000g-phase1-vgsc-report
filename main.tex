...
%
This analysis is very similar to hierarchical clustering, except that it allows for the reconstruction and placement of intermediate haplotypes that may not be observed in the data and allows much easier visulisation of the closely related 'leaves' of the dendrogram branches.
%
We constructed these networks up to a maximum distance of @@2 SNP differences, to ensure that each connected component in the resulting networks represents a collection of haplotypes with a recent common ancestor.
%
For haplotypes both haplotypes carrying \texttt{L995F} and \texttt{L995S}, the resulting networks confirm the presence of ten distinct clusters, with close correspondence to the clusters identified previously (\cite{Ag1000gConsortium2017}.
%
