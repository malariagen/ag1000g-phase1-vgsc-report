...
%
Thirteen of these novel alleles were found to occur almost exclusively on haplotypes carrying the known \texttt{L995F} resistance allele, and may be secondary mutations which enhance or compensate for the \texttt{L995F} resistance phenotype.
%
...
%
By 2012, over half of African households owned at least one pyrethroid impregnated ITN and nearly two thirds of IRS were programmes using pyrethroids \cite{Hemingway2016}. 
%
...
%
Unlike pyrethroids, however, DDT has not been widely used for IRS within the last two decades.
%
