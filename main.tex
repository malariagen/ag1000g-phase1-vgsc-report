...
%
Thirteen of these novel alleles occur almost exclusively on haplotypes carrying the known L995F resistance allele, and appear to be secondary mutations that may enhance or compensate for the primary resistance phenotype.
%
We also report an I1527T substitution which is adjacent to a predicted pyrethroid binding site in the channel molecule, and occurs in tight linkage with either of two alleles causing a V402L substitution, similar to a combination of substitutions recently found to cause pyrethroid resistance in Aedes @@TODO.
%
