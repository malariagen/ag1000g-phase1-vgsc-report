...
%
Haplotype data from genome regions both within and flanking the \textit{Vgsc} gene were therefore used to provide a higher resolution for reconstructing recent historical events.
%%
...
%%
For each pair of haplotypes, we estimated the length of the region shared identical by descent (IBD), then used these lengths and hierarchical clustering to build a dendrogram (Figure \ref{fig:tree}).
%
We studied the overall distribution of pairwise IBD  - cut - cluster
%%
