...
%
Thirteen novel non-synonymous alleles were found to occur almost exclusively on haplotypes carrying the known \texttt{L995F} resistance allele, and appear to be secondary mutations that may enhance or compensate for the \texttt{L995F} resistance phenotype.
%
The \texttt{I1527T} substitution, which is adjacent to a predicted pyrethroid binding site in the channel molecule, occurs in tight linkage with either of two alleles causing a \texttt{V402L} substitution, orthologous to a combination of substitutions found to cause pyrethroid resistance in other insect species.
%
...
%
We then use haplotype data from the chromosomal region spanning the \textit{Vgsc} gene to study the genetic backgrounds carrying resistance alleles, and infer the geographical spread of resistance between mosquito populations.
%
...
%
Codon \texttt{1527} occurs within trans-membrane segment \texttt{IIIS6}, immediately adjacent to residues within a predicted binding site for pyrethroid molecules, thus it is plausible that \texttt{I1527T} could alter pyrethroid binding \cite{Du2013,Dong2014}.
%
...
%
Substitutions in codon 402 have been found in a number of other insect species and shown experimentally to confer pyrethroid resistance \cite{Dong2014} @@TODO more recent citations in Aedes. 
%
