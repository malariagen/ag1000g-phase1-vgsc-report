...
%%
%
Our goal for analyses of the \textit{Vgsc} gene can now be restated, which is to perform an insecticide resistance outbreak analysis.
%
...
%
Note that separate outbreaks may be driven by the same resistance allele, and this can occur if multiple mutational events occur after the introduction of insecticides.
%
This can also occur if a resistance allele is present in mosquito populations as standing variation prior to the introduction of insecticides.
% 
