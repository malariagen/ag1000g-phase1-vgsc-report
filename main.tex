...
%
However, these studies analysed only small gene regions in a limited number of mosquito populations, and therefore had limited resolution to make inferences about genetic relationships between gene sequences (haplotypes) carrying this allele. 
%
...
%
This variant has only ever been found in association with \texttt{L995F} \cite{Jones2012}, and has been shown experimentally to substantially increase pyrethroid resistance when it occurs in combination with \texttt{L995F} \cite{Wang2015}.
%
