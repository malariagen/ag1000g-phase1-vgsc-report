...
%
The midpoint between the two modes of IBD distribution was taken as an estimation of the minimum length of IBD tract associated with a recent selective event and this was used to cut the IBD dendrogram, generating haplotype clusters (Figure \ref{fig:tree}).
%
