...
%
However, the presence of haplotypes from two different countries within the same network does not imply direct gene flow, as haplotypes could be transmitted to both locations from a third location, which may be unsampled.
%
%%
...
In contrast, networks F2, F3, S4 and S5 each contain haplotypes from Cameroon only, and S1 is private to Uganda.
%
The lack of any evidence for gene flow within these networks may indicate 
%%
