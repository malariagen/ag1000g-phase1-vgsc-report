...
%
If this tolerance exceeds the dosage present in ITNs or on indoor surfaces following IRS, these interventions may be rendered ineffective \cite{N’Guessan2007},\cite{Toe2014}.
%
...
%
Two of these substitutions occur in codon 995, with the Leucine $\rightarrow$ Phenylalanine (\texttt{L995S}) substitution prevalent in West and Central Africa \cite{Martinez-Torres1998},\cite{Silva2014}, and the Leucine $\rightarrow$ Serine (\texttt{L995S}) substitution found in Central and East Africa \cite{Ranson2000},\cite{Silva2014}.
%
...
%
Some of these variants fall within transmembrane coding regions, and thus may directly interact with insecticide molecules \cite{OReilly2006}, \cite{Davies2007b}.
%
...
%
Most previous studies of \emph{An. gambiae} and/or \emph{An. coluzzi} have performed targeted sequencing of small regions within the gene \cite{Pinto2007}, \cite{Etang2009}, \cite{Santolamazza2015}, and there has been no comprehensive survey of variation across the entire gene in multiple mosquito populations.
%%
...
%
Previous studies have found evidence that the \texttt{L995F} allele occurs on several different genetic backgrounds, suggesting multiple origins of resistance \cite{Pinto2007}, \cite{Etang2009}.
%
