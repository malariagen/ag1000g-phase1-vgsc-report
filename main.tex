...
%
There is evidence that pyrethroid resistance has a direct impact on the effectiveness of ITNs and IRS \cite{N’Guessan2007,Toé2014}, although assessing the impact on disease prevalence is difficult and has been hampered by the fact that pyrethroid resistance is now so pervasive that it is difficult to find mosquito populations with pyrethroid susceptibility at baseline to serve as controls \cite{WHO2016}.
%
Nevertheless, the position of WHO remains that insecticide resistance poses a grave threat to the huge gains made in reducing malaria across Africa \cite{WHO2012,WHO2016}.
%
