...
%
Thirteen of these novel alleles were found to occur almost exclusively on haplotypes carrying the known \texttt{L995F} resistance allele, and may enhance or compensate for the \texttt{L995F} resistance phenotype.
%
...
%
Seven of these clusters are localised to a single geographical location, and five comprise haplotypes from different countries, in one case separated by over 3000km, providing new information about the geographical distribution and spread of resistance.
%
...
%
Pyrethroids are the major class of insecticide approved for use in insecticide-treated bed-nets (ITNs), and are widely used in indoor residual spraying (IRS) campaigns as well as in agriculture.
%
...
%
However, these studies analysed only a small gene region (or several small regions in the case of \cite{Lynd2010}) in a limited number of mosquito populations, and therefore had limited resolution to make inferences about genetic relationships between gene sequences (haplotypes) carrying this allele. 
%
...
%
The \texttt{L995F} allele was at high frequency in populations of both species from West, Central and Southern Africa (Table \ref{table:variants_missense}).
%
The \texttt{L995S} allele was at high frequency among \textit{An. gambiae} populations from Central and East Africa (Table \ref{table:variants_missense}).
%
...
%
This variant has only ever been found in \textit{An. gambiae}/\textit{An. coluzzii} in association with \texttt{L995F} \cite{Jones2012}, and has been shown experimentally to substantially increase pyrethroid resistance when it occurs in combination with \texttt{L995F} \cite{Wang2015}.
%
...
%
We constructed these networks up to a maximum edge distance of 2 SNP differences, to ensure that each connected component in the resulting networks captures a collection of closely-related haplotypes (Figure \ref{fig:networks}).
%
...
%
Many of the nodes carrying secondary variants are large, consistent with positive selection and a functional role for these secondary variants as modifiers of the \texttt{L995F} resistance associated phenotype. 
%
...
%
These included core haplotypes corresponding to each of the 10 genetic backgrounds carrying \texttt{L995F} and \texttt{L995S} alleles identified above, as well as a core haplotype carrying \texttt{I1527T} which we labelled L1 due to it carrying the the wildtype codon (L) at position 995.
%
...
%
It has been suggested that \texttt{L995S} may have been primarily selected by DDT usage \cite{Lynd2010}.
%
...
%
However, it is more practical to develop targeted genetic assays for resistance outbreak surveillance that can scale to tens of thousands of mosquitoes at low cost and that could be implemented using existing platforms in national molecular biology facilities.
%%
%
