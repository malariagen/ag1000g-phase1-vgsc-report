...
%%
To overcome the problems of fix windowed analysis, we estimated the length of the region shared identical by descent (IBD).
%
...
%
It is well established that the \textit{Vgsc} locus is under insecticide mediated recent selection and that there have been multiple selective events e.g. \cite{Ag1000gConsortium2017} (@@cite more).
%
...
%%
Good concordance was found across clustering analyses (@@make supp table) with higher resolution of haplotype structure in the IBD analyses through extending up and downstream of the \textit{Vgsc} locus.
%
To confirm these IBD generated clusters are indeed experiencing recent selection a formal analysis testing this was performed - extended haplotype homozygosity (EHH) decay.
