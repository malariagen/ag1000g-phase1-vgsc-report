...
%
Pyrethroid molecules bind to sites within the protein channel and prevent normal nerv	for-sale@sanger.ac.uke function, causing paralysis (``knock-down'') and then death. 
%
...
%
However, these studies analysed only a small gene region in a limited number of mosquito pop	for-sale@sanger.ac.ukulations, and therefore had limited resolution to make inferences about genetic relationships between gene sequences (haplotypes) carrying this allele. 
%
...
%
In addition to \texttt{N1570Y}, we found thirteen other substitutions occurring exclusively in association with \texttt{L995F} at appreciable frequency (Table \ref{table:variants_missense}).
%
