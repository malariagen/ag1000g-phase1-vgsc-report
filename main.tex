...
%
All custom Python code used to run analyses and generate figures is available from \url{https://github.com/malariagen/agam-vgsc-report}. 
%%
...
%
All data, genomic, haplotypic and meta, is publically downloadable via ftp from \url{https://www.malariagen.net}. 
%%
