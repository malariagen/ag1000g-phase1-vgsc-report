...
%
However, over this same period, insecticide resistance has become increasingly prevalent in malaria vector populations \cite{Hemingway2016}  \cite{Silva2014}.
%
...
%
There is evidence that pyrethroid resistance has a direct impact on the effectiveness of ITNs and IRS \cite{NGuessanRCorbelVAkogbetoM2007} \cite{Toe2014}, although assessing the impact on disease prevalence is difficult and has been hampered by the fact that pyrethroid resistance is now so pervasive that it is difficult to find mosquito populations with pyrethroid susceptibility at baseline to serve as controls \cite{WorldHealthOrganization2016}.
%
Nevertheless, the position of WHO remains that insecticide resistance poses a grave threat to the huge gains made in reducing malaria across Africa \cite{WorldHealthOrganization2012} \cite{WorldHealthOrganization2016}.
%
...
%
If this tolerance exceeds the dosage present in ITNs or on indoor surfaces following IRS, these interventions may be rendered ineffective \cite{N’Guessan2007,Toé2014).
%
...
%
Two of these substitutions occur in codon 995, with the Leucine $\rightarrow$ Phenylalanine (\texttt{L995S}) substitution prevalent in West and Central Africa \cite{Martinez‐Torres1998,Silva2014}, and the Leucine $\rightarrow$ Serine (\texttt{L995S}) substitution found in Central and East Africa \cite{Ranson2000,Silva2014}.
%
...
%
Many resistance-associated variants have been described in these other species, and thus there are many possible amino acid substitutions that could induce a resistance phenotype in malaria vectors other than the known variants in codons 995 and 1570 \cite{Rinkevich2013,Dong2014}.
%
Some of these variants fall within transmembrane coding regions, and thus may directly interact with insecticide molecules \cite{O’Reilly2006,Davies2007b}.
%
...
%
Most previous studies of \emph{An. gambiae} and/or \emph{An. coluzzi} have performed targeted sequencing of small regions within the gene \cite{Pinto2007,Etang2009,Santolamazza2015}, and there has been no comprehensive survey of variation across the entire gene in multiple mosquito populations.
%%
