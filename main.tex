...
%
Pyrethroids target the voltage-gated sodium channel (VGSC), an essential component of the mosquito nervous system, but mutations in the VGSC gene (\emph{Vgsc}) can disrupt the activity of these insecticides, inducing a resistance phenotype. 
%
...
%
For each variant we predict a resistance phenotype based on genetic evidence for recent selection, then use analyses of haplotype structure to refine our understanding of the origins and spread of these resistance variants between species and geographical locations.
%
These analyses identify ten distinct lineages, each of which carries one or more resistance alleles and appears to be undergoing rapid and recent expansion in one or more populations.
%
Analysis of recombination against putative ancestral haplotypes reveal lineages are unrelated and thus represent independent outbreaks of resistance.
%
Results demonstrate the molecular basis of \emph{Vgsc} mediated pyrethroid resistance in African malaria vectors is more complex than previously appreciated, and provide a foundation for the development of new genetic tools to inform insecticide resistance management and track the further spread of resistance.
%%
...
%
An estimated 663 million cases of malaria were averted in Africa between 2000 and 2015 due to public health interventions, of which 68\% were prevented by insecticide-treated bed-nets (ITNs) and 10\% through indoor residual spraying of insecticides (IRS) (Bhatt et al., 2015).
%
However, over this same period, insecticide resistance has become increasingly prevalent in malaria vector populations (Hemingway et al., 2016; Silva et al., 2014).
%
...
%
There is evidence that pyrethroid resistance has a direct impact on the effectiveness of ITNs and IRS (Toé et al., 2014; N’Guessan et al., 2007), although assessing the impact on disease prevalence is difficult and has been hampered by the fact that pyrethroid resistance is now so pervasive that it is difficult to find mosquito populations with pyrethroid susceptibility at baseline to serve as controls (WHO, 2016).
%
Nevertheless, the position of WHO remains that insecticide resistance poses a grave threat to the huge gains made in reducing malaria across Africa (WHO, 2012; WHO, 2016).
%
Improvements are needed in our ability to monitor resistance, and gaps must be filled in our knowledge of the molecular mechanisms.
%%
...
%
However, amino acid substitutions at key positions within the channel can alter the interaction with the insecticide molecule, thereby substantially increasing the dosage of insecticide required for knock-down (hence described as knock-down resistance or \emph{kdr} - Davies et al., 2007a).
%
If this tolerance exceeds the dosage present in ITNs or on indoor surfaces following IRS, these interventions may be rendered ineffective (Toé et al., 2014; N’Guessan et al., 2007).
%
...
%
Two of these substitutions occur in codon 995, with the Leucine $\rightarrow$ Phenylalanine (\texttt{L995S}) substitution prevalent in West and Central Africa (Martinez‐Torres et al., 1998; Silva et al., 2014), and the Leucine $\rightarrow$ Serine (\texttt{L995S}) substitution found in Central and East Africa (Ranson et al., 2000; Silva et al., 2014).
%
A third variant \texttt{N1570Y} has been found in association with \texttt{L995F} in Central Africa and shown to increase resistance above \texttt{L995F} alone (Jones et al., 2012).
%%
...
%
Because of its essential function, the VGSC protein is highly conserved across insect species (Davies et al., 2007b), and therefore knowledge gained from one species is relevant to another.
%
Many resistance-associated variants have been described in these other species, and thus there are many possible amino acid substitutions that could induce a resistance phenotype in malaria vectors other than the known variants in codons 995 and 1570 (Rinkevich, Du & Dong, 2013; Dong et al., 2014).
%
Some of these variants fall within transmembrane coding regions, and thus may directly interact with insecticide molecules (O’Reilly et al., 2006; Davies et al., 2007b).
%
However, functional studies have also demonstrated that variants within internal linker domains can substantially enhance the the level of resistance, when present in combination with channel modifications (Jones et al., 2012).
%
Most previous studies of \emph{An. gambiae} and/or \emph{An. coluzzi} have performed targeted sequencing of small regions within the gene (Pinto et al., 2007; Santolamazza et al., 2015; Etang et al., 2009), and there has been no comprehensive survey of variation across the entire gene in multiple mosquito populations.
%%
...
%
Insecticide resistance monitoring in malaria vector populations now often incorporates some form of genetic assay to detect the allele present at \emph{Vgsc} codon 995 (e.g. Bass et al., 2007).
%
Both alleles are present at high frequency in multiple geographical locations, and the \texttt{L995F} allele is present in both \emph{An. gambiae} and \emph{An. coluzzii} (Silva et al., 2014).
%
The extent of mosquito migration remains an open question, however mosquitoes do travel between different locations and have the potential to spread resistance alleles from one population to another (adaptive gene flow) (Dao et al., 2014).
%
Hybridization between mosquito species also occurs and has the potential to transfer resistance alleles between species (adaptive introgression); studies in West Africa have shown that the \texttt{L995F} allele has been transferred from \emph{An. gambiae} into \emph{An. coluzzii} populations  (Clarkson et al., 2014).
%
A resistance allele may also arise independently in multiple populations in the absence of gene flow (Reimer et al., 2005), either because of multiple mutational events occurring after insecticides are introduced (selection on new mutations), or because resistance alleles were already present at low frequency in mosquito populations prior to insecticide use (selection on standing variation).
%
Previous studies have found evidence that the \texttt{L995F} allele occurs on several different genetic backgrounds, suggesting multiple origins of resistance (Pinto et al., 2007; Etang et al., 2009).
%
...
%
Initial Ag1000g findings are confirmed then analyses extended to investigate the age, movement and recombination of insecticide resistance conferring haplotypes.
%
